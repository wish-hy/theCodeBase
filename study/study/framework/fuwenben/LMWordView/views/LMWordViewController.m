...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [HYItemTool itemButtonWithTitle:@"预览" highTitle:@"预览" target:self action:@selector(previewClick)];
