...
- (void)configerSubViews {
    for(int i = 0; i < self.titleArray.count; i ++) {
        ...
        if(imageName.length != 0 && imageName != nil) {
            ...
            titleButton.imageEdgeInsets = UIEdgeInsetsMake(0, 5, 0, -(35+buttonTitleSize.width));
...
//        UILabel *linLB = [[UILabel alloc]initWithFrame:CGRectMake(buttonWith*i - 5, (50-12)/2, 2, 12)];
