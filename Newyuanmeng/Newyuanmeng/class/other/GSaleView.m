...
@interface GSaleView()<UITableViewDelegate,UITableViewDataSource>
...
- (void)setUser_id:(NSInteger)user_id withToken:(NSString *)token{
    ...
    [MySDKHelper postAsyncWithURL:@"/v1/get_promoter_sale_record" withParamBodyKey:keys withParamBodyValue:values needToken:_token postSucceed:^(NSDictionary *result) {
        NSLog(@"我是数据%@",result);
        //解析
        //容错
