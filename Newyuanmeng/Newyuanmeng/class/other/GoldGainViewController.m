...
@interface GoldGainViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation GoldGainViewController

- (void)viewDidLoad {
    [super viewDidLoad];
//    NSLog(@"%ld,%@",self.userID,self.token);
