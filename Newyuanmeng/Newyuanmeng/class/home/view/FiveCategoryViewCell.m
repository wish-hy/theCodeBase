...
@implementation FiveCategoryViewCell
...
-(void)layoutSubviews
{
    if (_status == 0) {
        ...
        _image1.frame = CGRectMake(0, banner_Height, ScreenWidth/3 - 1, (self.height - banner_Height)*0.6 - 1);
//        _ads2.frame = CGRectMake(0, self.height - banner_Height, ScreenWidth, 0);
        _ads2.frame = CGRectMake(0,0,0,0);
    }else{
        _ads1.frame = CGRectMake(0, 0, 0, 0);
//        _ads1.frame = CGRectMake(0, 0, ScreenWidth, 0);
        _image1.frame = CGRectMake(0, 0, ScreenWidth/3 - 1, (self.height - banner_Height)*0.6 - 1);
        _ads2.frame = CGRectMake(0, self.height - banner_Height, ScreenWidth, banner_Height);
    }
    _image2.frame = CGRectMake(_image1.width + 1, _image1.y,ScreenWidth/3 - 1, (self.height - banner_Height)*0.6 - 1);
    _image3.frame = CGRectMake(_image1.width * 2 + 2, _image1.y,ScreenWidth/3 - 1, (self.height - banner_Height)*0.6 - 1);
    _image4.frame = CGRectMake(0, _image1.y + _image1.height + 1,ScreenWidth/2 - 1, (self.height - banner_Height)*0.4 + 1);
    _image5.frame = CGRectMake(_image4.width + 1, _image1.y + _image1.height + 1, ScreenWidth/2 - 1, (self.height - banner_Height)*0.4 + 1);
}
