...
protocol CFCityPickerVCDelegate{
    ...
    func selectedCityModel(_ cityPicker: CFCityPickerVC, cityModel:CFCityPickerVC.CityModel)
}
...
class CFCityPickerVC: UIViewController {
    ...
    lazy var selectedCityArray: [String] = {UserDefaults.standard.object(forKey: SelectedCityKey) as? [String] ?? []}()
