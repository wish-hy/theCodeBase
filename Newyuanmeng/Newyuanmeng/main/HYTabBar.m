...
@property (nonatomic,assign) HYItemUIType type;

@property (nonatomic, strong) NSString *centerBtnIconNomer;
@property (nonatomic, strong) NSString *centerBtnIconSelect;
...
-(void)setCenterBtnIcon:(NSString *)centerBtnIconNomer centerBtnIconSelect:(NSString *)centerBtnIconSelect{
    _centerBtnIconNomer = centerBtnIconNomer;
    _centerBtnIconSelect = centerBtnIconSelect;
    [self.centerButton setBackgroundImage:[UIImage imageNamed:self.centerBtnIconNomer] forState:UIControlStateNormal];
    [self.centerButton setBackgroundImage:[UIImage imageNamed:self.centerBtnIconSelect] forState:UIControlStateHighlighted];
}
